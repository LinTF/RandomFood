...
const breakfast_list = [
    "漢堡", "饅頭", "燒餅油條", "飯糰", "吐司", "果醬厚片", "蛋餅", "麵包", "包子", "水煎包", "咖啡店", "速食店", "便利商店", "小籠包", "西式", "中式"
];

// 午餐清單
const lunch_list = [
    "鐵板燒", "鍋燒麵", "燒臘便當", "雞腿便當", "便當", "速食店", "湯麵", "水餃", "控肉飯", "滷味", "肉圓", "甜不辣", "麵線羹", "水煎包", "壽司", "自助餐"
];

// 晚餐清單
const dinner_list = [
    "臭豆腐", "鹽水雞", "雞排", "滷味", "便當", "沙威瑪", "水餃", "刈包", "炸物", "肉圓", "甜不辣", "水煎包", "湯麵", "速食店", "牛排", "韓式", "泰式", "港式", "越式", "日式", "壽司", "章魚燒", "自助餐"
];
